...
export default function EditMovie() {
    ...
    useEffect(async () => {
        const dataMoviesRaw = await axios.get(`${herokuURL}/movies/${sessionStorage.getItem("idEditMovie")}`)
        console.log("movies: ")
    ...
    const updateMovie = async(e)=>{
      ...
      const respondDB = await axios.put(`${herokuURL}/movies/${sessionStorage.getItem("idEditMovie")}`,newMovie)
      navigate("/movies")
    }
