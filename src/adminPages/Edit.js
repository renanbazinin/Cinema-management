...
export default function Edit() {
    ...
    useEffect(async() => {
        ...
        const userFromJSON = await axios.get(`${herokuURL}/users/userfile`)
        ...
        try{
            const userData = await axios.get(`${herokuURL}/users/${sessionStorage.getItem("idEdit")}`)
    ...
    const updatePut = async(e)=>{
        ...
        const res = await axios.put(`${herokuURL}/users/${sessionStorage.getItem("idEdit")}`,
        {
        ...
        const resPutUser = await axios.put(`${herokuURL}/users/userfile`
        ,
        {
            id:sessionStorage.getItem("idEdit"),
            fName:user.fName,
        ...
        const resPutPer = await axios.put(`${herokuURL}/users/permissionsfile`
        ,
        {
            id:sessionStorage.getItem("idEdit"),
            premissions:perArr
