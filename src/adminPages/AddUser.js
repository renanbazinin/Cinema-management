...
export default function AddUser() {
  ...
  const creatUser = async()=>{
    ...
    const resCheckIfExsit = await axios.get(`${herokuURL}/users`)
    let flagExsit=false;
    ...
    const res = await axios.post(`${herokuURL}/users`,
    {
    ...
    const resPutUser = await axios.post(`${herokuURL}/users/userfile`
    ,
    {
        id:newId,
        fName:user.fName,
    ...
    const resPutPer = await axios.post(`${herokuURL}/users/permissionsfile`
    ,
    {
        id:newId,
        premissions:perArr
